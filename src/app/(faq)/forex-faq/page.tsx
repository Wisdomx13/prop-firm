...
export const metadata: Metadata = {
  title: "Forex FAQ | Pipzen Prop Firm Forex Trading Questions & Answers",
  description:
    "Find answers to all your forex trading questions with Pipzen. Learn about forex trading rules, profit splits, account leverage, evaluation guidelines, and funded account policies in our Forex FAQ.",
  keywords: [
    "forex FAQ Pipzen",
    "forex prop firm questions",
    "forex funded account FAQ",
    "prop firm forex rules",
    "forex profit split policies",
    "forex trading prop firm guidelines",
    "Pipzen forex trading FAQ",
    "forex evaluation rules",
    "trading forex funded account",
    "forex prop firm leverage FAQ",
  ],
  openGraph: {
    title: "Forex FAQ | Pipzen Prop Firm Forex Trading Questions & Answers",
    description:
      "Browse Pipzen’s Forex FAQ section to get answers about trading forex on funded accounts, leverage rules, profit splits, and prop firm forex guidelines.",
    url: "https://www.pipzen.io/forex-faq",
    siteName: "Pipzen",
    images: [
      {
        url: "/images/pipzen-forex-faq.png", // replace with your actual OG image
        width: 1200,
        height: 630,
        alt: "Pipzen Forex FAQ",
      },
    ],
    type: "website",
  },
  ...
  alternates: {
    canonical: "https://www.pipzen.io/forex-faq",
  },
};
